...
async def get_note_list(db: AsyncSession, user_id: Optional[int]) -> list[Note]:
    """
...
async def create_note(db: AsyncSession, note: SchemaNote, user: User) -> Note:
    """
...
async def change_note(db: AsyncSession, note_id: int, note: SchemaNoteOptional) -> Note:
    """
